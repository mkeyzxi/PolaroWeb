...
const StripsPage: React.FC = () => {
  ...
  const [layout, setLayout] = useState<LayoutType>('3strips')
  ...
  return (
    <>
      <SEO
        title={seoData['strip-layout'].title}
        description={seoData['strip-layout'].description}
        keywords={seoData['strip-layout'].keywords}
        canonicalUrl={seoData['strip-layout'].canonicalPath}
      />
