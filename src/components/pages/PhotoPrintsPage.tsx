...
const PhotoPrintsPage: React.FC = () => {
  ...
  return (
    <>
      <SEO
        title={seoData['photo-prints'].title}
        description={seoData['photo-prints'].description}
        keywords={seoData['photo-prints'].keywords}
        canonicalUrl={seoData['photo-prints'].canonicalPath}
      />
